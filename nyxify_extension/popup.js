...
function savePopupSettings(options = {}) {
  ...
  const payload = {
    ...
    adaptiveEmailProviderEnabled: getCheckedSetting("popupAdaptiveEmailProviderToggle", "adaptiveEmailProviderEnabled", false),
    adaptivePhoneProviderEnabled: getCheckedSetting("popupAdaptivePhoneProviderToggle", "adaptivePhoneProviderEnabled", false),
